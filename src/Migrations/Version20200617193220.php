 ...
 */
final class Version20200617193220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE general_instrument CHANGE code code INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE general_instrument CHANGE code code VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE poste_travail CHANGE section_id section_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE specific_instrument CHANGE general_instrument_id general_instrument_id INT DEFAULT NULL');
