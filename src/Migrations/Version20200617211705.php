 ...
 */
final class Version20200617211705 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specific_instrument CHANGE general_instrument_id general_instrument_id INT DEFAULT NULL, CHANGE poste_id poste_id INT DEFAULT NULL, CHANGE marque_id marque_id INT DEFAULT NULL');
