 ...
 */
final class Version20200617210358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specifique_instrument CHANGE poste_id poste_id INT DEFAULT NULL, CHANGE marque_id marque_id INT DEFAULT NULL');
