 ...
 */
final class Version20200617181709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE specifique_instrument (id INT AUTO_INCREMENT NOT NULL, numero VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE poste_travail CHANGE section_id section_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE specific_instrument CHANGE general_instrument_id general_instrument_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE specifique_instrument');
        $this->addSql('ALTER TABLE poste_travail CHANGE section_id section_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE specific_instrument CHANGE general_instrument_id general_instrument_id INT DEFAULT NULL');
